...
media_das_series__de_retornos_das_acoes_por_setor = function(ano){
...
# setores_2008_1 = media_das_series__de_retornos_das_acoes_por_setor("2008.1")
# setores_2008_2 = media_das_series__de_retornos_das_acoes_por_setor("2008.2")
# setores_2009_1 = media_das_series__de_retornos_das_acoes_por_setor("2009.1")
# setores_2009_2 = media_das_series__de_retornos_das_acoes_por_setor("2009.2")
# setores_2010_1 = media_das_series__de_retornos_das_acoes_por_setor("2010.1")
# setores_2010_2 = media_das_series__de_retornos_das_acoes_por_setor("2010.2")
# setores_2011_1 = media_das_series__de_retornos_das_acoes_por_setor("2011.1")
# setores_2011_2 = media_das_series__de_retornos_das_acoes_por_setor("2011.2")
# setores_2012_1 = media_das_series__de_retornos_das_acoes_por_setor("2012.1")
# setores_2012_2 = media_das_series__de_retornos_das_acoes_por_setor("2012.2")
# setores_2013_1 = media_das_series__de_retornos_das_acoes_por_setor("2013.1")
# setores_2013_2 = media_das_series__de_retornos_das_acoes_por_setor("2013.2")
# setores_2014_1 = media_das_series__de_retornos_das_acoes_por_setor("2014.1")
...
for(semestre in faixa_temporal){
  serie_retornos_normalizado = media_das_series__de_retornos_das_acoes_por_setor(semestre)
  
  for(coluna in 1:length(names(serie_retornos_normalizado))){
    colunas[i] = names(serie_retornos_normalizado)[coluna]
    faixa_temporal_por_setores[i] = semestre
