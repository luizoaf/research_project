...
# pontos_estranhos_B = dados[dados$coeficiente_B>as.numeric(quantile(dados$coeficiente_B,.97)),]
...
# "ABEV3.SA" "ALLL3.SA" "BRAP4.SA" "CSNA3.SA" "HGTX3.SA" "RENT3.SA"
serie_retornos = read.csv("serie_retornos_normalizado.csv")
# > 99 %
plot(serie_retornos$ABEV3,type="l")
plot(serie_retornos$ALLL3.SA,type="l")
plot(serie_retornos$CSNA3.SA,type="l")
plot(serie_retornos$BRAP4.SA,type="l")
# > 98 %
plot(serie_retornos$HGTX3.SA,type="l")
plot(serie_retornos$RENT3.SA,type="l")
# > 97.8%
plot(serie_retornos$POMO4.SA,type="l")
