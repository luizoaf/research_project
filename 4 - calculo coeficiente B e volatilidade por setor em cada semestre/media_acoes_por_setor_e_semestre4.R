...
semestre = "2014.1"
cluster_2014_1 = cbind(data.frame(cluster = retorna_cluster(semestre)),com_b_menor_que_2[com_b_menor_que_2$semestres_por_setores==semestre,c("colunas","coeficiente_B","volatilidade" )])
